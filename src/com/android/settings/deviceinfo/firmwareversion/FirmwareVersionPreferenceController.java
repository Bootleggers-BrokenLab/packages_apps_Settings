...
import static com.android.settings.deviceinfo.firmwareversion.BOOTLEGGERSVersionPreferenceController.BOOTLEGGERS_PROP;
...
public class FirmwareVersionPreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        ...
        final String romVersion = SystemProperties.get(BOOTLEGGERS_PROP, versionDef);
