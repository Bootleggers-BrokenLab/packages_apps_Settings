...
public class PreventRingingParentPreferenceController extends TogglePreferenceController
    ...
    public boolean isChecked() {
        ...
        if (preventRinging == null) preventRinging = BOOTLEGGERS_VOLUME_HUSH_OFF;
        return !preventRinging.equals(BOOTLEGGERS_VOLUME_HUSH_OFF);
    }
    ...
    public boolean setChecked(boolean isChecked) {
        String preventRingingSetting = Settings.Secure.getString(
                mContext.getContentResolver(), VOLUME_HUSH_GESTURE);
        if (preventRingingSetting == null) preventRingingSetting = BOOTLEGGERS_VOLUME_HUSH_OFF;

        final String newRingingSetting = preventRingingSetting.equals(BOOTLEGGERS_VOLUME_HUSH_OFF)
                ? BOOTLEGGERS_VOLUME_HUSH_VIBRATE : preventRingingSetting;

        return Settings.Secure.putString(mContext.getContentResolver(),
                VOLUME_HUSH_GESTURE, isChecked
                        ? newRingingSetting
                        : BOOTLEGGERS_VOLUME_HUSH_OFF);
    }
    ...
    public void updateState(Preference preference) {
        ...
        if (value == null) value = BOOTLEGGERS_VOLUME_HUSH_OFF;
        StringBuilder summary = new StringBuilder(
                mContext.getString(R.string.switch_off_text));
        if (isVolumePowerKeyChordSetToHush()) {
            if (!value.equals(BOOTLEGGERS_VOLUME_HUSH_OFF)) {
